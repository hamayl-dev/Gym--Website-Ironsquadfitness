...
const calculateBmi = (e) => {
  ...
  if (cm === '' || kg === '') {
    ...
    calculateMessage.textContent = '⚠️ Please enter both Height and Weight'
...
/*=============== EMAIL JS ===============*/
  ...
  const sendEmail = (e) => {
    ...
    if (contactUser.value === '') {
        contactMessage.classList.remove('color-yellow')
        ...
        emailjs.sendForm('service_1arz7nr','template_3n2fbve','#contact-form','2t_3w1ovgIpIbVMiR') 
            .then(() => {
                 contactMessage.classList.add('color-yellow')
